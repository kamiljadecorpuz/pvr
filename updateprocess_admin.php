...
$subBbqSma = $cottage_bbq_small1 - $cottage_bbq_small2;
    ...
    ?>
            ...
            echo '<tbody style="font-weight:700;color:red;font-size:12px;">';
		...
		echo "<br><h4 style='color:red;'>Original Customer Request ".$row_id['date_today']."</h4>";
		
		echo "<label style='color:red;font-size:12px;'>Customer's Information:<br> &nbsp;&nbsp;&nbsp;".$row_id['fname']."&nbsp;&nbsp;".$row_id['mname']."&nbsp;&nbsp;".$row_id['sname']."<br>&nbsp;&nbsp;&nbsp;" .$row_id['contact']."</label><br>";
...
$subBbqSma = $cottage_bbq_small1 - $cottage_bbq_small2;
 ...
 <form name="insert_form" method="post" action="insertprocess_reservation_admin.php" onSubmit="return validate(this);">
...
<!--<label>TRANSACTION NUMBER: </label>-->
	...
	<!--<input name="id" id="id" type="text" class="form-control" style="border-radius:5px;" readonly="readonly"  value="<?php /*?><?php echo $row_id['id'];?><?php */?>">-->
 ...
 <br /><br />
  <strong>ENCODER IDENTIFICATION :</strong><br>

  
  <input  name="encoder" id="encoder" type="text" class="form-control" placeholder="Encoder"  readonly value="<?php echo $row_user['id']; echo " - "; echo $row_user['code']; ?>">
  ...
  <select name="status" id="status" class="form-control" placeholder="status">
   ...
   <br><br>
    ...
    <input name="fname" id="fname" type="text" class="form-control" placeholder="First name" required="required"  value="<?php echo $row_id['fname'];?>">
        
         <input name="mname" id="mname" type="text" class="form-control" placeholder="Middle name" required="required"  value="<?php echo $row_id['mname'];?>">
        
    <input name="sname" id="sname" type="text" class="form-control" placeholder="Surname" required="required"  value="<?php echo $row_id['sname'];?>">
    
   <input name="contact" id="contact" type="text" class="form-control" maxlength ="12" 
    placeholder="Contact Number" required="required"  value="<?php echo $row_id['contact'];?>"><br>
...
?>
	...
	<tr>
    <td> 
    <input name="date_transaction" id="date_transaction" type="date" class="form-control"  required="required" value="<?php echo $row_id['date_transaction']; ?>" placeholder="mm/dd/yyyy">
...
<br />
 ...
 var arr = document.getElementsByName('tot');
	...
	if (document.getElementById("cash_tendered").value >= document.getElementById("tot_pay").value ){

	
	var result = Math.abs(( document.getElementById("cash_tendered").value - document.getElementById("tot_pay").value));
	
    document.getElementById('client_change').value = result.toFixed(2);
	}
   ...
   <div class="row">
    ...
    <br />
	<br /><select name="Medium_Cottage" id="Medium_Cottage" class="form-control"  onChange="computation1()" style="border-radius:5px;width:100px" placeholder="No."  value="<?php echo $row_id['Medium_Cottage']; ?>">
    ...
    <br />
    <br /><select name="Small_Cottage" id="Small_Cottage" class="form-control"  onChange="computation2()" style="border-radius:5px;width:100px" placeholder="No."  value="<?php echo $row_id['Small_Cottage']; ?>">
    ...
    <br />
    <br /><select name="Twin_Exotic" id="Twin_Exotic"  class="form-control"  onChange="computation3()" style="border-radius:5px;width:100px" placeholder="No."   value="<?php echo $row_id['Twin_Exotic']; ?>">
      <option value="0" selected="selected">0</option>
    <option value="1">1</option>
    <option value="2">2</option>
    </select>
    ...
    <br />
    <br /><select name="Single_Huts_Exotic" id="Single_Huts_Exotic" type="text" class="form-control"  onChange="computation4()" style="border-radius:5px;width:100px" placeholder="No."   value="<?php echo $row_id['Single_Huts_Exotic']; ?>">
      <option value="0" selected="selected">0</option>
    <option value="1">1</option>
    <option value="2">2</option>
    <option value="3">3</option>
    ...
    <br />
    <br />	<select  name="pavillion_day" id="pavillion_day" type="text" class="form-control"  onChange="computation5()" style="border-radius:5px;width:100px" placeholder="No."  value="<?php echo $row_id['pavillion_day']; ?>" >
     <option value="0" selected="selected">0</option>
    <option value="1">1</option>
    </select> 
    ...
    <br />
    <br /><select name="pavillion_night" id="pavillion_night" type="text" class="form-control"  onChange="computation6()" style="border-radius:5px;width:100px" placeholder="No."  value="<?php echo $row_id['pavillion_night']; ?>">
     <option value="0" selected="selected">0</option>
    <option value="1">1</option>
    </select> 
	...
	<br /><font color="blue" size="2">[10 Persons]</font>
     ...
     <br />               
   <br /> <select name="cottage_bbq_small" id="cottage_bbq_small" type="text" class="form-control"  onChange="computation7()" style="border-radius:5px;width:100px" placeholder="No."  value="<?php echo $row_id['cottage_bbq_small']; ?>" >
    ...
    <br />
     <br /><select name="cottage_bbq_big" id="cottage_bbq_big" type="text" class="form-control"  onChange="computation8()" style="border-radius:5px;width:100px" placeholder="No."   value="<?php echo $row_id['cottage_bbq_big']; ?>" >
    <option value="0" selected="selected">0</option>
    <option value="1">1</option>
    <option value="2">2</option>
    <option value="3">3</option>
...
<br />
    ...
    placeholder="No."   value="<?php echo $row_id['add_person_promo']; ?>">
...
<td>
<br>
<select name="payprocess" id="payprocess" class="form-control"   value="<?php echo $row_id['payprocess']; ?>">
...
<input name="tot_pay" id="tot_pay" type="text" class="form-control" onblur="total_computation()" required="required"
 ...
 <br>
 <input type="button" onclick="change()" value="Calculate Change" class="btn btn-info" >
 <br><br> <strong>Cash Tendered :</strong><br>
<input name="cash_tendered" id="cash_tendered"  class="form-control" required="required" placeholder="0.00" ><br>


<br> <strong>Client Change :</strong><br>

<input name="client_change" id="client_change"  class="form-control" required="required"
 readonly
 placeholder="0.00"  >
        <br><br><br>
...
<label>Bamboo Cottage with Barbeque Grill [22 Persons] </label>
 ...
 <div class="row">
 		...
 		FROM
	 <input name="from_time" id="from_time" type="text" class="form-control"  required="required"  onChange="shiftfixed()" readonly="readonly"  value="<?php echo $row_id['from_time']; ?>">
				</div>
    
   				 <div class="col-lg-6">
 		TO
    <input name="to_time" id="to_time" type="text" class="form-control" required="required" onChange="shiftfixed()" readonly="readonly"  value="<?php echo $row_id['to_time']; ?>">
