            ...
            <div class="row" >
				...
				<div class="col-lg-12">
  					...
  					<div class="col-lg-3" style=" border-radius:7px;"><br>
                        ...
                        <h4>Admin ID: <?php echo $row_user['id'];?></h4>
                    ...
                    <!--    
                       ...
                       <!-- <a href="update_accounts_emp.php"  data-toggle="tooltip" data-placement="right" title="Edit account"><i class="fa fa-fw fa-edit"  style="font-size:14px;"></i>&nbsp;<strong>Manage Account</strong>&nbsp;&nbsp;&nbsp;</a>
                          <br>
                         // <?php 
//                       echo' <a href="logged_employee.php?'.$row_user['code'].'"  data-toggle="tooltip" data-placement="right" title="Reserve now"><i class="fa fa-fw fa-file-o"  style="font-size:14px;"></i>&nbsp;<strong>Reservation Form</strong>&nbsp;&nbsp;&nbsp;</a>' ?>
                         <br>-->
...
echo "<a href='viewprocess_admin.php?id=".$row['id']."'><i class='fa fa-fw fa-folder-open-o'  style='font-size:16px;' data-toggle='tooltip' data-placement='bottom' title='View'></i></a> &nbsp;";

echo "<a href='updateprocess_admin.php?id=".$row['id']."'><i class='fa fa-fw fa-edit'  style='font-size:16px;' data-toggle='tooltip' data-placement='bottom' title='Edit'></i></a> &nbsp;";

echo "<a href='deleteprocess_admin.php?id=".$row['id']."'><i class='fa fa-fw fa-times'  style='font-size:16px;' data-toggle='tooltip' data-placement='bottom' title='Delete'></i></a>";
}
