...
<?php
include("code_session.php");

?>


<input name="code" id="code" type="password" class="form-control" style="border-radius:4px;height:35px;width:300px;font-size:18px;" placeholder= "Employee Code"  required="required">
<br />
