...
$cottage_bbq_small2 = $row2['SUM(cottage_bbq_small)'];
		...
		echo $row2['SUM(cottage_bbq_small)'];
             ...
             <a href="welcome_emp.php"><button class="btn btn-info">VIEW ALL REQUEST</button></a>
...
<button type="submit" class="btn btn-default" style="border-radius:10px;width:60px;height:50px"><img src="icons/save-icon.png" stretch="true" title="Submit Application Form" ></button>
  ...
  <input  name="encoder" id="encoder" type="text" class="form-control" placeholder="Encoder"  readonly value="<?php echo $row_user['id_no']; echo" - "; echo $row_user['sname'];?>">
   ...
   <br><br>
    ...
    <input name="fname" id="fname" type="text" class="form-control" placeholder="First name" required="required" >
        
         <input name="mname" id=="mname" type="text" class="form-control" placeholder="Middle name" required="required">
        
    <input name="sname" id=="sname" type="text" class="form-control" placeholder="Surname" required="required">
    
   <input name="contact" id="contact" type="text" class="form-control" maxlength ="12" 
    placeholder="Contact Number" required="required"><br>
